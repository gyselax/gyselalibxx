...
from XY_tool_functions import plot_energy_conservation

# ---------------------------------------------------------------------------
current_folder = Path(__file__).parent

parser = argparse.ArgumentParser(description="Plot and save the energy conservation of a given output folder.")
...
# ---------------------------------------------------------------------------
plot_energy_conservation(folder, name_file)
