...
#--------------------------------------------------
# Plot the time evolution of abs(Phi) to compute
#  the Landau damping rate and frequency
#--------------------------------------------------
def plot_Landau_damping(Phi,timegrid,
                        time_end=None,
                        dirname=".",
                        plotfig=False):
...
save_group.add_argument('--no-save', dest='save', action='store_false', help="Don't save figures")
