...
# - forward and backward coefficients: 'forward' for (0,1,2,3,4) and 'backward' for (-4,-3,-2,-1,0)
...
dic_coeff_FD['[1,6],forward']  = np.array([-147.,360.,-450.,400.,-225.,72.,-10.])/denom
dic_coeff_FD['[1,6],backward'] = np.array([10.,-72.,225.,-400.,450.,-360.,147.])/denom
dic_coeff_FD['[1,6],mixed_p']  = np.array([-10.,-77.,150.,-100.,50.,-15.,2.])/denom
dic_coeff_FD['[1,6],mixed_m']  = np.array([-2.,15.,-50.,100.,-150,77.,10.])/denom

denom = 180.
dic_coeff_FD['[2,6],centered'] = np.array([2.,-27.,270.,-490.,270.,-27.,2.])/denom
dic_coeff_FD['[2,6],forward']  = np.array([938.,-4014.,7911.,-9490.,7380.,-3618.,1019.,-126.])/denom
dic_coeff_FD['[2,6],backward'] = np.array([-126.,1019.,-3618.,7380.,-9490.,7911.,-4014.,938.])/denom
dic_coeff_FD['[2,6],mixed_p']  = np.array([126.,-70.,-486.,855.,-670.,324.,-90.,11.])/denom
dic_coeff_FD['[2,6],mixed_m']  = np.array([11.,-90.,324.,-670.,855.,-486.,-70.,126.])/denom
...
def Deriv_nthorder(F, dx, periodic=0, nth_deriv=1 , order=4):
    ...
    #  --> example for 4th order : dnFdxn[i] = c[0](F[i-2]-F[i+2]) + c[1](F[i-1]-F[i+1])
