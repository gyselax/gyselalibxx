...
def Plot_POPEcoeff_forPoisson(
    ...
    #VG#ax1.yaxis.set_major_formatter(ticker.FormatStrFormatter(ticker_strformat))
    my_plot_( fig, ax1,
              xgrid[nx_bound:nx-nx_bound], timegrid, qe[:,nx_bound:nx-nx_bound],
              'x', 't', 'POPE qe' )

    ax2 = fig.add_subplot(122)
    #VG#ax2.yaxis.set_major_formatter(ticker.FormatStrFormatter(ticker_strformat))
    my_plot_( fig, ax2,
...
def Plot_iPOPEcoeff_forPoisson(
    ...
    vgrid = dic_iPOPEcoeff_Poisson['vgrid']
    ...
    ax1 = fig.add_subplot(131)    
    p1 = ax1.plot(xgrid[nx_bound:nx-nx_bound],
    ...
    p2 = ax2.plot(xgrid[nx_bound:nx-nx_bound],
                  np.log10(abs_iPOPE_error_q[nx_bound:nx-nx_bound]))
    ax2.set_xlabel('x')
    ax2.set_title('log10|<error_q>|')

    ax3 = fig.add_subplot(133)
    p3 = ax3.semilogy(xgrid[nx_bound:nx-nx_bound],
...
def Plot_iPOPEcoeff_forVlasov(
    ...
    ax1 = fig.add_subplot(131)    
    p1 = ax1.pcolormesh(xgrid[nx_bound:nx-nx_bound],vgrid[nv_bound:nv-nv_bound],
                        iPOPE_index_e[nx_bound:nx-nx_bound,nv_bound:nv-nv_bound].T)
    fig.colorbar(p1)
    ax1.set_xlabel('x')    
    ax1.set_ylabel('v')
    ...
    p2 = ax2.pcolormesh(xgrid[nx_bound:nx-nx_bound],vgrid[nv_bound:nv-nv_bound],
                        np.log10(abs_iPOPE_error_e[nx_bound:nx-nx_bound,nv_bound:nv-nv_bound]).T)
    fig.colorbar(p2)
    ax2.set_xlabel('x')
    ax2.set_ylabel('v')
    ...
    ax3 = fig.add_subplot(133)
    p3 = ax3.pcolormesh(xgrid[nx_bound:nx-nx_bound],vgrid[nv_bound:nv-nv_bound],
                        iPOPE_residu_e[nx_bound:nx-nx_bound,nv_bound:nv-nv_bound].T)
    fig.colorbar(p3)
    ax3.set_xlabel('x')
    ax3.set_ylabel('v')
    ...
    if fion_exist:
        ...
        ax1 = fig.add_subplot(131)
        p1 = ax1.pcolormesh(xgrid[nx_bound:nx-nx_bound],vgrid[nv_bound:nv-nv_bound],
                            iPOPE_index_i[nx_bound:nx-nx_bound,nv_bound:nv-nv_bound].T)
        fig.colorbar(p1)
        ax1.set_xlabel('x')
        ax1.set_ylabel('v')
        ...
        p2 = ax2.pcolormesh(xgrid[nx_bound:nx-nx_bound],vgrid[nv_bound:nv-nv_bound],
                            np.log10(abs_iPOPE_error_i[nx_bound:nx-nx_bound,nv_bound:nv-nv_bound].T))
        fig.colorbar(p2)
        ax2.set_xlabel('x')
        ax2.set_ylabel('v')
        ...
        ax3 = fig.add_subplot(133)
        p3 = ax3.pcolormesh(xgrid[nx_bound:nx-nx_bound],vgrid[nv_bound:nv-nv_bound],
                            iPOPE_residu_i[nx_bound:nx-nx_bound,nv_bound:nv-nv_bound].T)
        fig.colorbar(p3)
        ax3.set_xlabel('x')
        ax3.set_ylabel('v')
