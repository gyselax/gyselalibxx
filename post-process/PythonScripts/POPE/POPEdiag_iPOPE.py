...
def Compute_iPOPEcoeff_forPoisson(
    ...
    *************************************************
    ...
    d2xPhi_POPE = dic_POPEop_Poisson['d2xPhi_POPE']
...
def Get_iPOPEcoeff_forPoisson(
    ...
    if os.path.exists(POPE_h5filename):
        ...
        if dic_iPOPEcoeff_Poisson_exist:
            print('==> Loading of iPOPE coefficients for Poisson in '+POPE_h5filename)
    ...
    H5ut.save_dict_to_hdf5( dic_iPOPEcoeff_Poisson, h5group_iPOPEcoeff_Poisson, POPE_h5filename )
...
def Compute_iPOPEcoeff_forVlasov(
    ...
    *************************************************
    ...
    for it in range(nt):
        print("iPOPE for Vlasov for electrons at time " + str(it) + "--> " + str(timegrid[it]))
