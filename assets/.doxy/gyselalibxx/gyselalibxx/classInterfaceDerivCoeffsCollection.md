...
[**ClassList**](annotated.md) **>** [**InterfaceDerivCoeffsCollection**](classInterfaceDerivCoeffsCollection.md)
...
**See also:** [**InterfaceDerivCoeffs**](classInterfaceDerivCoeffs.md). 
...
_Get a derivative calculator of the collection. The output cannot be copied. This operator only allows to get a temporary reference to call one of the operators of the_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _class._
```C++
template<class Interface>
inline InterfaceDerivCoeffs < Interface > const & InterfaceDerivCoeffsCollection::get () const
```
