...
* **m\_idxrange\_quadrature** ([**PolarSplineFEMPoissonLikeSolver**](classPolarSplineFEMPoissonLikeSolver.md))
...
* **s\_nbc\_xmax** ([**IdentityInterpolationBuilder**](classIdentityInterpolationBuilder.md))
* **s\_nbc\_xmin** ([**IdentityInterpolationBuilder**](classIdentityInterpolationBuilder.md))
