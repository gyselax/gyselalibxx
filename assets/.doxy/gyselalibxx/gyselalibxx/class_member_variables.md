...
* **is\_periodic** ([**LagrangeInterpolator**](classLagrangeInterpolator.md), [**SplineInterpolator**](classSplineInterpolator.md))
...
* **m\_epsilon** ([**AdvectionFieldFinder**](classAdvectionFieldFinder.md), [**CartesianToCzarny**](classCartesianToCzarny.md), [**CombinedMapping**](classCombinedMapping.md), [**CrankNicolson**](classCrankNicolson.md), [**CrankNicolson&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classCrankNicolson_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md), [**CrankNicolsonBuilder**](classCrankNicolsonBuilder.md), [**CzarnyToCartesian**](classCzarnyToCartesian.md), [**KelvinHelmholtzInstabilityInitialisation**](classKelvinHelmholtzInstabilityInitialisation.md), [**PolarFootFinder**](classPolarFootFinder.md))
...
* **m\_spline\_evaluator** ([**AdvectionFieldFinder**](classAdvectionFieldFinder.md), [**BslPredCorrRTheta**](classBslPredCorrRTheta.md), [**DiscretePoloidalCSSplineMapping**](classDiscretePoloidalCSSplineMapping.md), [**FEM1DPoissonSolver**](classFEM1DPoissonSolver.md), [**GyroAverageOperator**](classGyroAverageOperator.md))
...
* **m\_function\_evaluator** ([**BslAdvection1D**](classBslAdvection1D.md), [**BslAdvectionSpatial**](classBslAdvectionSpatial.md), [**BslAdvectionVelocity**](classBslAdvectionVelocity.md))
* **m\_time\_stepper\_builder** ([**BslAdvection1D**](classBslAdvection1D.md), [**PolarFootFinder**](classPolarFootFinder.md), [**SplinePolarFootFinder**](classSplinePolarFootFinder.md))
...
* **m\_evaluator** ([**BslExplicitPredCorrRTheta**](classBslExplicitPredCorrRTheta.md), [**BslImplicitPredCorrRTheta**](classBslImplicitPredCorrRTheta.md), [**DiscretePoloidalCSSplineMappingBuilder**](classDiscretePoloidalCSSplineMappingBuilder.md), [**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md), [**GMGPolarTools::PolarPoissonLikeCoefficients**](classGMGPolarTools_1_1PolarPoissonLikeCoefficients.md), [**LagrangeInterpolator**](classLagrangeInterpolator.md), [**PoissonLikeRHSFunction**](classPoissonLikeRHSFunction.md), [**PolarSplineFEMPoissonLikeSolver::CoeffEvaluator**](classPolarSplineFEMPoissonLikeSolver_1_1CoeffEvaluator.md), [**PolarSplineFEMPoissonLikeSolver**](classPolarSplineFEMPoissonLikeSolver.md), [**RefinedDiscretePoloidalCSSplineMappingBuilder**](classRefinedDiscretePoloidalCSSplineMappingBuilder.md), [**Spline1DPartialDerivative**](classSpline1DPartialDerivative.md), [**Spline1DPartialDerivativeCreator**](classSpline1DPartialDerivativeCreator.md), [**Spline2DPartialDerivative**](classSpline2DPartialDerivative.md), [**Spline2DPartialDerivativeCreator**](classSpline2DPartialDerivativeCreator.md), [**SplineInterpolator**](classSplineInterpolator.md))
* **m\_logical\_to\_physical** ([**BslExplicitPredCorrRTheta**](classBslExplicitPredCorrRTheta.md), [**BslImplicitPredCorrRTheta**](classBslImplicitPredCorrRTheta.md), [**PolarFootFinder**](classPolarFootFinder.md), [**polar\_foot\_finder\_details::ElementwisePhysicalAdvPhysicalFootFinder**](classpolar__foot__finder__details_1_1ElementwisePhysicalAdvPhysicalFootFinder.md), [**polar\_foot\_finder\_details::ElementwisePhysicalAdvPhysicalFootFinderMem**](classpolar__foot__finder__details_1_1ElementwisePhysicalAdvPhysicalFootFinderMem.md))
...
* **m\_o\_point** ([**CartesianToCircular**](classCartesianToCircular.md), [**CartesianToCzarny**](classCartesianToCzarny.md), [**CircularToCartesian**](classCircularToCartesian.md), [**DiscretePoloidalCSSplineMapping**](classDiscretePoloidalCSSplineMapping.md))
...
* **m\_coeff\_idx** ([**ConstantIdentityInterpolationExtrapolationRule**](classConstantIdentityInterpolationExtrapolationRule.md))
...
* **m\_max\_counter** ([**CrankNicolson**](classCrankNicolson.md), [**CrankNicolson&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classCrankNicolson_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md), [**CrankNicolsonBuilder**](classCrankNicolsonBuilder.md))
* **m\_idx\_range** ([**CrankNicolson&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classCrankNicolson_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md), [**Euler&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classEuler_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md), [**RK2&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classRK2_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md), [**RK3&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classRK3_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md), [**RK4&lt; FieldMem, DerivFieldMem, ExecSpace &gt;**](classRK4_3_01FieldMem_00_01DerivFieldMem_00_01ExecSpace_01_4.md))
* **m\_metric\_tensor** ([**Curl**](classCurl.md), [**Gradient**](classGradient.md), [**LiePoissonBracket**](classLiePoissonBracket.md))
* **m\_coordinate\_origin** ([**CzarnyToCartesian**](classCzarnyToCartesian.md))
...
* **m\_idx\_range\_singular\_point** ([**DiscretePoloidalCSSplineMapping**](classDiscretePoloidalCSSplineMapping.md), [**DiscretePoloidalCSSplineMappingBuilder**](classDiscretePoloidalCSSplineMappingBuilder.md), [**RefinedDiscretePoloidalCSSplineMappingBuilder**](classRefinedDiscretePoloidalCSSplineMappingBuilder.md))
* **m\_x\_spline\_representation** ([**DiscretePoloidalCSSplineMapping**](classDiscretePoloidalCSSplineMapping.md))
* **m\_y\_spline\_representation** ([**DiscretePoloidalCSSplineMapping**](classDiscretePoloidalCSSplineMapping.md))
* **m\_curvilinear\_to\_x\_spline\_alloc** ([**DiscretePoloidalCSSplineMappingBuilder**](classDiscretePoloidalCSSplineMappingBuilder.md), [**RefinedDiscretePoloidalCSSplineMappingBuilder**](classRefinedDiscretePoloidalCSSplineMappingBuilder.md))
* **m\_curvilinear\_to\_y\_spline\_alloc** ([**DiscretePoloidalCSSplineMappingBuilder**](classDiscretePoloidalCSSplineMappingBuilder.md), [**RefinedDiscretePoloidalCSSplineMappingBuilder**](classRefinedDiscretePoloidalCSSplineMappingBuilder.md))
...
* **m\_absTol** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md))
* **m\_coeff\_alpha** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md), [**GMGPolarTools::PolarPoissonLikeCoefficients**](classGMGPolarTools_1_1PolarPoissonLikeCoefficients.md))
* **m\_coeff\_beta** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md), [**GMGPolarTools::PolarPoissonLikeCoefficients**](classGMGPolarTools_1_1PolarPoissonLikeCoefficients.md))
* **m\_density\_coeffs** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md))
* **m\_domain\_geom** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md))
* **m\_extrapolation\_rule** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md), [**MultipatchSplineEvaluator2D**](classMultipatchSplineEvaluator2D.md))
* **m\_max\_iterations** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md))
* **m\_relTol** ([**GMGPolarPoissonLikeSolver**](classGMGPolarPoissonLikeSolver.md))
* **m\_to\_physical** ([**GMGPolarTools::MappingToDomainGeometry**](classGMGPolarTools_1_1MappingToDomainGeometry.md))
...
* **m\_lower\_extrap\_rule** ([**LagrangeEvaluator**](classLagrangeEvaluator.md))
* **m\_upper\_extrap\_rule** ([**LagrangeEvaluator**](classLagrangeEvaluator.md))
* **m\_max\_extrapolation** ([**LagrangeInterpolator**](classLagrangeInterpolator.md), [**SplineInterpolator**](classSplineInterpolator.md))
* **m\_min\_extrapolation** ([**LagrangeInterpolator**](classLagrangeInterpolator.md), [**SplineInterpolator**](classSplineInterpolator.md))
* **m\_coeff** ([**LeviCivitaTensor**](classLeviCivitaTensor.md), [**PolarSplineFEMPoissonLikeSolver::CoeffEvaluator**](classPolarSplineFEMPoissonLikeSolver_1_1CoeffEvaluator.md))
* **m\_grad** ([**LiePoissonBracket**](classLiePoissonBracket.md))
* **m\_reference\_point\_on\_input\_dim** ([**LinearCoordTransform**](classLinearCoordTransform.md))
* **m\_reference\_point\_on\_output\_dim** ([**LinearCoordTransform**](classLinearCoordTransform.md))
* **m\_scaling\_factor** ([**LinearCoordTransform**](classLinearCoordTransform.md))
...
* **m\_size** ([**MatrixBatch**](classMatrixBatch.md))
...
* **m\_transforms** ([**OrthogonalCoordTransforms**](classOrthogonalCoordTransforms.md))
* **m\_coefs** ([**PoissonLikeRHSFunction**](classPoissonLikeRHSFunction.md))
...
* **m\_builder\_advection\_field** ([**PolarFootFinder**](classPolarFootFinder.md), [**SplinePolarFootFinder**](classSplinePolarFootFinder.md))
* **m\_coord\_centre\_pc** ([**PolarFootFinder**](classPolarFootFinder.md))
...
* **m\_n\_non\_zero\_bases\_theta** ([**PolarSplineFEMPoissonLikeAssembler**](classPolarSplineFEMPoissonLikeAssembler.md), [**PolarSplineFEMPoissonLikeSolver**](classPolarSplineFEMPoissonLikeSolver.md))
...
* **m\_coeff\_deriv\_patch\_1** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_coeff\_deriv\_patch\_2** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_extremity\_1** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_extremity\_2** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_idx\_range\_perp\_1** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_idx\_range\_perp\_2** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_is\_cell\_bound\_1\_with\_extra\_interpol\_pt** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_is\_cell\_bound\_2\_with\_extra\_interpol\_pt** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_weights\_patch\_1** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_weights\_patch\_1\_alloc** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_weights\_patch\_2** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_weights\_patch\_2\_alloc** ([**SingleInterfaceDerivativesCalculator**](classSingleInterfaceDerivativesCalculator.md))
* **m\_derivative\_calculator\_collection** ([**SingleInterfaceDerivativesCalculatorCollection**](classSingleInterfaceDerivativesCalculatorCollection.md))
...
* **m\_physical\_to\_logical** ([**polar\_foot\_finder\_details::ElementwisePhysicalAdvPhysicalFootFinder**](classpolar__foot__finder__details_1_1ElementwisePhysicalAdvPhysicalFootFinder.md))
...
* **s\_n\_gauss\_legendre\_r** ([**PolarSplineFEMPoissonLikeAssembler**](classPolarSplineFEMPoissonLikeAssembler.md), [**PolarSplineFEMPoissonLikeSolver**](classPolarSplineFEMPoissonLikeSolver.md))
* **s\_n\_gauss\_legendre\_theta** ([**PolarSplineFEMPoissonLikeAssembler**](classPolarSplineFEMPoissonLikeAssembler.md), [**PolarSplineFEMPoissonLikeSolver**](classPolarSplineFEMPoissonLikeSolver.md))
...
* **using\_vector\_field** ([**IPoissonSolver&lt; IdxRange&lt; ODims... &gt;, IdxRangeFull, DataType, MemorySpace, LayoutSpace &gt;**](classIPoissonSolver_3_01IdxRange_3_01ODims_8_8_8_01_4_00_01IdxRangeFull_00_01DataType_00_01MemorySpace_00_01LayoutSpace_01_4.md), [**IPolarPoissonLikeSolver&lt; IdxRange&lt; ODims... &gt;, IdxRangeFull, MemorySpace, LayoutSpace &gt;**](classIPolarPoissonLikeSolver_3_01IdxRange_3_01ODims_8_8_8_01_4_00_01IdxRangeFull_00_01MemorySpace_00_01LayoutSpace_01_4.md))
