...
[**ClassList**](annotated.md) **>** [**InterfaceDerivCoeffs**](classInterfaceDerivCoeffs.md)



_Compute the coefficients a, b and c of the interface derivative reconstruction method._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
|   | [**InterfaceDerivCoeffs**](#function-interfacederivcoeffs-14) (IdxRange1DPerp\_1 const & idx\_range\_1d\_1, IdxRange1DPerp\_2 const & idx\_range\_1d\_2, ddc::SplineBuilderClosure const & Closure1=ddc::SplineBuilderClosure::HERMITE, ddc::SplineBuilderClosure const & Closure2=ddc::SplineBuilderClosure::HERMITE) <br>_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _._ |
|   | [**InterfaceDerivCoeffs**](#function-interfacederivcoeffs-24) (IdxRangeA const & idx\_range\_a, IdxRangeB const & idx\_range\_b, ddc::SplineBuilderClosure const & Closure1=ddc::SplineBuilderClosure::HERMITE, ddc::SplineBuilderClosure const & Closure2=ddc::SplineBuilderClosure::HERMITE) <br>_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _. See_InterfaceDerivCoeffsInstantiator _._ |
|   | [**InterfaceDerivCoeffs**](#function-interfacederivcoeffs-34) (IdxRange1DPerp\_1 const & idx\_range\_1d\_1, IdxRange1DPerp\_2 const & idx\_range\_1d\_2, std::size\_t const number\_chosen\_cells) <br>_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _. See_InterfaceDerivCoeffsInstantiator _. This constructor calculates an approximation of the formula._ |
|   | [**InterfaceDerivCoeffs**](#function-interfacederivcoeffs-44) (IdxRangeA const & idx\_range\_a, IdxRangeB const & idx\_range\_b, std::size\_t const number\_chosen\_cells) <br>_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _. See_InterfaceDerivCoeffsInstantiator _. This constructor calculates an approximation of the formula._ |
|  double | [**get\_approx\_deriv**](#function-get_approx_deriv-12) (DConstField&lt; IdxRange1DPerp\_1, Kokkos::HostSpace, Layout1 &gt; const & function\_1, DConstField&lt; IdxRange1DPerp\_2, Kokkos::HostSpace, Layout2 &gt; const & function\_2) const<br>_Get the linear combination of the function values (c)._  |
|  double | [**get\_approx\_deriv**](#function-get_approx_deriv-22) (DConstField&lt; IdxRange1DPerp\_2, Kokkos::HostSpace, Layout2 &gt; const & function\_2, DConstField&lt; IdxRange1DPerp\_1, Kokkos::HostSpace, Layout1 &gt; const & function\_1) const<br>_Get the linear combination of the function values (c). See_ get\_approx\_deriv _._ |
...
For a given [**Interface**](structInterface.md), this operator computes the coefficients a, b and c of the following relation between the interface derivative and the derivatives at the other boundaries of the two patches: \(s'(X_I) = c + a s'(X_{I+1}) + b s'(X_{I+1})\),
...
* c a linear combination of the function values on the two patches. The weights in the linear combination depend on the meshes of the two patches. It can be written as a sum: \(c = \sum_{k = -N2}^{N1} \omega_k f_k\), with \(\omega_k\) the weights, \(f_k\) the function values,




By default, \(N1\) the number of cells in patch 1, and \(N2\) the number of cells in patch 2.


But a constructor is also provided to choose $N\_{trunc}=N1=N2$ in order to calculate an approximation of the derivative: \(s'(X_I) \simeq c_{trunc} = \sum_{k = -N_{trunc}}^{N_{trunc}} \omega_k f_k\).
...
* `InterfaceType` The interface between two patches where we want to compute the derivatives. 
...
```C++
using InterfaceDerivCoeffs< InterfaceType >::associated_interface =  InterfaceType;
```
...
### function InterfaceDerivCoeffs [1/4]

_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _._
```C++
inline InterfaceDerivCoeffs::InterfaceDerivCoeffs (
...
### function InterfaceDerivCoeffs [2/4]

_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _. See_InterfaceDerivCoeffsInstantiator _._
```C++
...
### function InterfaceDerivCoeffs [3/4]

_Instantiate_ [_**InterfaceDerivCoeffs**_](classInterfaceDerivCoeffs.md) _. See_InterfaceDerivCoeffsInstantiator _. This constructor calculates an approximation of the formula._
```C++
inline InterfaceDerivCoeffs::InterfaceDerivCoeffs (
    IdxRange1DPerp_1 const & idx_range_1d_1,
    IdxRange1DPerp_2 const & idx_range_1d_2,
...
### function InterfaceDerivCoeffs [4/4]
...
### function get\_approx\_deriv [1/2]

_Get the linear combination of the function values (c)._ 
```C++
template<class Layout1, class Layout2>
inline double InterfaceDerivCoeffs::get_approx_deriv (
...
This linear combination corresponds to an approximation of the interface derivative.
...
### function get\_approx\_deriv [2/2]

_Get the linear combination of the function values (c). See_ get\_approx\_deriv _._
```C++
template<class Layout1, class Layout2>
inline double InterfaceDerivCoeffs::get_approx_deriv (
    DConstField< IdxRange1DPerp_2, Kokkos::HostSpace, Layout2 > const & function_2,
...
inline double InterfaceDerivCoeffs::get_coeff_deriv_on_patch () const
```
...
```C++
inline double InterfaceDerivCoeffs::get_coeff_deriv_patch_1 () const
```
...
```C++
inline double InterfaceDerivCoeffs::get_coeff_deriv_patch_2 () const
```
