...
**template &lt;class... GridPDEDim1D, class IdxRangeFull, class ExecSpace, class DataType, class LayoutSpace&gt;**



[**ClassList**](annotated.md) **>** [**FFTPoissonSolver&lt; IdxRange&lt; GridPDEDim1D... &gt;, IdxRangeFull, ExecSpace, DataType, LayoutSpace &gt;**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md)
...
| Type | Name |
| ---: | :--- |
| struct | [**GridFourier**](structFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace08643bb19194ad52eddd8dcdca1c1cd8.md) &lt;class Dim&gt;<br> |
...
| typedef FieldMem&lt; Kokkos::complex&lt; DataType &gt;, [**fourier\_idx\_range\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-fourier_idx_range_type), [**memory\_space**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-memory_space) &gt; | [**fourier\_field\_mem\_type**](#typedef-fourier_field_mem_type)  <br>_The type of a Field storing the Fourier transform of a function._  |
...
| Type | Name |
| ---: | :--- |
|   | [**FFTPoissonSolver**](#function-fftpoissonsolver) ([**laplacian\_idx\_range\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-laplacian_idx_range_type) laplacian\_idx\_range) <br>_A constructor for the FFT Poisson solver. This constructor calls ddc::init\_discrete\_space so it should only be called once per simulation._  |
|  void | [**negative\_differentiate\_equation**](#function-negative_differentiate_equation) ([**fourier\_field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-fourier_field_type) derivative, [**fourier\_field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-fourier_field_type) values) const<br>_Differentiate and multiply by -1 an expression in Fourier space by multiplying by -i \* k This function should be private. It is not due to the inclusion of a KOKKOS\_LAMBDA._  |
| virtual [**field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-field_type) | [**operator()**](#function-operator) ([**field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-field_type) phi, [**field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-field_type) rho) const<br>_An operator which calculates the solution_ \(\phi\) _to Poisson's equation:_\(- \Delta \phi = \rho\) _._ |
| virtual [**field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-field_type) | [**operator()**](#function-operator_1) ([**field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-field_type) phi, [**vector\_field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-vector_field_type) E, [**field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-field_type) rho) const<br>_An operator which calculates the solution_ \(\phi\) _to Poisson's equation and its derivative:_\(- \Delta \phi = \rho\) __\(E = - \nabla \phi\) _._ |
|  void | [**solve\_poisson\_equation**](#function-solve_poisson_equation) ([**fourier\_field\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-fourier_field_type) intermediate\_chunk, Field&lt; DataType, [**laplacian\_idx\_range\_type**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-laplacian_idx_range_type), [**memory\_space**](classFFTPoissonSolver_3_01IdxRange_3_01GridPDEDim1D_8_8_8_01_4_00_01IdxRangeFull_00_01ExecSpace_1c9dfec6217f60d85d58886a3eeace05.md#typedef-memory_space), Layout &gt; rho) const<br>_A function to solve the Poisson equation in Fourier space This function should be private. It is not due to the inclusion of a KOKKOS\_LAMBDA._  |
...
* `DataType` The type of the data. This controls the precision of the calculations. 
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::batch_idx_range_type =  typename base_type::batch_idx_range_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::batch_index_type =  typename base_type::batch_index_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::const_field_type =  typename base_type::const_field_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::field_type =  typename base_type::field_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::fourier_field_mem_type =  FieldMem<Kokkos::complex<DataType>, fourier_idx_range_type, memory_space>;
```
...
_The type of a Field storing the Fourier transform of a function._ 
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::fourier_field_type =  typename fourier_field_mem_type::span_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::fourier_idx_range_type =  IdxRange<GridFourier<typename GridPDEDim1D::continuous_dimension_type>...>;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::fourier_index_type =  typename fourier_idx_range_type::discrete_element_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::laplacian_idx_range_type =  typename base_type::laplacian_idx_range_type;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::layout_space =  typename base_type::layout_space;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::memory_space =  typename base_type::memory_space;
```
...
```C++
using FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::vector_field_type =  typename base_type::vector_field_type;
```
...
```C++
inline explicit FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::FFTPoissonSolver (
...
```C++
template<class Dim>
inline void FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::negative_differentiate_equation (
...
```C++
inline virtual field_type FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::operator() (
    field_type phi,
    field_type rho
) const
```
...
inline void FFTPoissonSolver< IdxRange< GridPDEDim1D... >, IdxRangeFull, ExecSpace, DataType, LayoutSpace >::solve_poisson_equation (
    fourier_field_type intermediate_chunk,
    Field< DataType, laplacian_idx_range_type , memory_space , Layout > rho
) const
```
