...
[**File List**](files.md) **>** [**coord\_transformations**](dir_67161c4ffadea73fddf46ea451c2f62c.md) **>** [**barycentric\_to\_cartesian.hpp**](barycentric__to__cartesian_8hpp.md)
...
public:
    ...
    CartesianToBarycentric<X, Y, Corner1Tag, Corner2Tag, Corner3Tag> get_inverse_mapping() const
    {
        return CartesianToBarycentric<
                X,
                Y,
                Corner1Tag,
                Corner2Tag,
                Corner3Tag>(m_corner1, m_corner2, m_corner3);
    }
};
```
