...
public:
    ...
    explicit PolarSplineFEMPoissonLikeAssembler(
        ...
        //     // GaussLegendre<QDimRMesh, s_n_gauss_legendre_r> const& gl_coeffs_r)
        //     // GaussLegendre<QDimThetaMesh, s_n_gauss_legendre_theta> const& gl_coeffs_theta)
...
public:
                                          ...
                                          - ddc::discrete_space<BSplinesTheta>().nbasis())))
    {
        ...
        // m_int_volume_alloc = FieldMem<double, IdxRangeQuadratureRTheta>(std::move(assembler.m_int_volume_alloc));

        // ddc::parallel_deepcopy(m_int_volume_alloc, assembler.m_int_volume_alloc);
