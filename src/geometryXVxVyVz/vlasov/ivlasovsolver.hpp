...
public:
     ...
     * @param[in] efield_z The electric field in the z direction computed at all spatial positions. 
    ...
    virtual DFieldSpVxVyVzX operator()(
            ...
            DConstFieldX efield_x,
            DConstFieldX efield_y,
            DConstFieldX efield_z,
            double dt) const = 0;
};
