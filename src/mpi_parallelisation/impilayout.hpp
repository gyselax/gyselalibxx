...
public:
    ...
    using distributed_subdomain = ddc::DiscreteDomain<DistributedDim...>;
...
private:
    ...
    static constexpr bool check_distributed_domains_are_first(
...
public:
     ...
     */
    static constexpr bool distributed_domains_are_first = check_distributed_domains_are_first(
