...
public:
    ...
    virtual DSpanX operator()(DSpanX inout_data, DViewX coordinates) const = 0;
};
...
public:
    ...
    virtual DSpanX operator()(DSpanX const inout_data, DViewX const coordinates) const override
    {
