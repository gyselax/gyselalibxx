...
protected:
    ...
    virtual void solve_lambda_section(mdspan_1d& v,
        mdspan_1d const& u) const override;
    virtual void solve_lambda_section(mdspan_2d& v,
        mdspan_2d const& u) const override;
    virtual void solve_lambda_section_transpose(mdspan_1d& v, mdspan_1d const& u)
        const override;
