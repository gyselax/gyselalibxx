...
public:
    ...
    static std::unique_ptr<Matrix> make_new_banded(int n,
        int kl,
        int ku,
        bool pds);
    static std::unique_ptr<Matrix> make_new_periodic_banded(int n,
        int kl,
        int ku,
        bool pds);
...
protected:
    ...
    virtual int solve_inplace_method(const char transpose,
        double* b,
        int nrows,
        int ncols) const = 0;
