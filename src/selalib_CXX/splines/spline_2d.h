...
public:
    ...
    ~Spline_2D();
    bool belongs_to_space(const BSplines& bspline1,
    ...
    template <bool deriv1, bool deriv2>
    void eval_array_deriv(mdspan_2d const& x1,
        mdspan_2d const& x2,
        mdspan_2d& y) const;
...
private:
    ...
    template <
        ...
        class T2,
        typename std::enable_if<std::is_base_of<BSplines, T2>::value>::type* = nullptr>
    void eval_array_loop(mdspan_2d const& x1,
        mdspan_2d const& x2,
        mdspan_2d& y) const;
