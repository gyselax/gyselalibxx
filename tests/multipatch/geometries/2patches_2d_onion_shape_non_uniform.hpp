...
/*
    Geometry defined here: 2 * 2D patches.
        - patch 1 and patch 2: 
            ...
            - non uniform GridR and GridTheta; 
*/
#pragma once
...
namespace onion_shape_non_uniform_2d_2patches {
 ...
 */
template <int PatchIdx>
struct BSplinesR : ddc::NonUniformBSplines<R, BSplineDegree>
{
};
 ...
 */
template <int PatchIdx>
struct BSplinesTheta : ddc::NonUniformBSplines<Theta, BSplineDegree>
{
};
