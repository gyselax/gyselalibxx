...
/*
    ...
    The geometry describes a figure of eight such that:
        - Dim2 of Patch 1 is connected to Dim1 of Patch 2
        - Dim1 of Patch 4 is connected to Dim2 of Patch 5

    The outside describes a circle such that:
        - Dim1 of Patch 1 is connected to Dim2 of Patches 2 and 4
        - Dim1 of Patch 5 is connected to Dim2 of Patches 2 and 4
...
using Patch3InterfaceSouth = Interface<SouthEdge3, NorthEdge5, true>;
using Patch3InterfaceEast = Interface<EastEdge3, WestEdge4, true>;
using Patch3InterfaceWest = Interface<WestEdge3, EastEdge2, true>;

using LoopInterface_2_1 = Interface<NorthEdge2, WestEdge1, true>;
using LoopInterface_1_4 = Interface<EastEdge1, NorthEdge4, true>;
using LoopInterface_4_5 = Interface<SouthEdge4, EastEdge5, true>;
using LoopInterface_5_2 = Interface<WestEdge5, SouthEdge2, true>;

using EightInterface_2_1 = Interface<WestEdge2, NorthEdge1, true>;
using EightInterface_5_4 = Interface<SouthEdge5, EastEdge4, true>;
