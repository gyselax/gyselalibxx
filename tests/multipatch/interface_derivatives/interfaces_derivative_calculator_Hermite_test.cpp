...
#include "interfaces_derivative_calculator.hpp"
#include "interfaces_derivative_calculator_test_utils.hpp"
...
/*
    Test InterfacesDerivativeCalculator on the following geometry:
    ...
    > test with approximation formulation in InterfacesDerivCoeffs. 
...
struct ChangeBound1
{
    ...
    using CoordTransform1 = ChangeBound1Transform;
    using CoordTransform2 = AlignedPatchTransform<2>;
    using CoordTransform3 = AlignedPatchTransform<3>;
...
struct ChangeBound3
{
    ...
    using CoordTransform1 = AlignedPatchTransform<1>;
    using CoordTransform2 = AlignedPatchTransform<2>;
    using CoordTransform3 = ChangeBound3Transform;
...
struct InterfacesDerivativeCalculatorHermiteFixture : public ::testing::Test
{
...
public:
    InterfacesDerivativeCalculatorHermiteFixture()
    ...
    static void SetUpTestSuite()
    {
        ...
        IdxRange<GridXg> idx_range_xg_1 = idx_range_xg.take_first(nbreaks_per_patch);
        IdxRange<GridXg> idx_range_xg_2
                = idx_range_xg.remove(nbreaks_per_patch - 1, nbreaks_per_patch - 1);
        IdxRange<GridXg> idx_range_xg_3 = idx_range_xg.take_last(nbreaks_per_patch);
...
TYPED_TEST_SUITE(InterfacesDerivativeCalculatorHermiteFixture, TestTypes);
} // end namespace



TYPED_TEST(InterfacesDerivativeCalculatorHermiteFixture, CheckForHermiteBc)
{
