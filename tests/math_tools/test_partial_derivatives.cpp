...
static void TestSplinePartialDerivativeDx()
{
    int n_elems_x(10);
    int n_elems_y(20);
    ...
    SplinePartialDerivative<SplineXBuilder, SplineXEvaluator> partial_dx(builder_x, spline_evaluator_x);
