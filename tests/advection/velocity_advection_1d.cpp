...
// Lagrange basis for the function interpolation
...
public:
    ...
    static void SetUpTestSuite()
    {
        ...
        IdxRangeVx const lagrange_vx_domain(SplineInterpPointsVx::get_domain<GridVx>());
        ddc::init_discrete_space<LagBasisVx>(lagrange_vx_domain);
    }
