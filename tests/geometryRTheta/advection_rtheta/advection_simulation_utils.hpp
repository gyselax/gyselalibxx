 ...
 *      The index range of the domain to which the poloidal coordinate should be restricted.
 */
 ...
 *      domain.
 * @param[in] grid
 *      The index range of the logical domain where the function is defined.
 ...
 * @param[in] grid
 *      The index range of the logical domain on which the advected function is defined.
