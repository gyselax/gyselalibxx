...
TEST(GeometryXM, PredCorrHybrid)
{
    ...
    host_t<DFieldVx> const quadrature_coeffs_host(
            neumann_spline_quadrature_coefficients<Kokkos::DefaultHostExecutionSpace>(meshVx, builder_vx_poisson));
    auto quadrature_coeffs=ddc::create_mirror_view_and_copy(Kokkos::DefaultExecutionSpace(),
