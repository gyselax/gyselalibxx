...
TEST(TensorTools, RepeatedIndices)
{
    ...
    using NonRepeatedIndices = non_repeated_indices_t<TypeSeqVectorIdxMap>;
    using UniqueIndices = unique_indices_t<TypeSeqVectorIdxMap>;
...
TEST(TensorTest, CartesianLeviCivitaEnabledAsTensorType)
{
    ...
    static_assert(
            ...
            "CartesianLeviCivitaTensor should be recognized as a tensor type");
